...
const indexProductoRouter = require("../routes/indexProductos")
...
const adapter = new FileSync("dbindexProducto.json")
const dbindexProducto = low(adapter);

//inicializamos LA DB
dbindexProducto.defaults({indexProducto:[]}).write();
const app =express(); //creamos el aplicativo
app.dbindexProducto = dbindexProducto;
//definimos las variables necesarias.
app.use(cors());
app.use(express.json());
app.use(morgan("dev"));
app.use("/indexProductos",indexProductoRouter)
