...
const indexCafeteriaRouter = require("../routes/indexCafeterias")
...
const adapter = new FileSync("dbindexCafeteria.json")
const dbindexCafeteria = low(adapter);

//inicializamos LA DB
dbindexCafeteria.defaults({indexCafeteria:[]}).write();
const app =express(); //creamos el aplicativo
app.dbindexCafeteria = dbindexCafeteria;
//definimos las variables necesarias.
app.use(cors());
app.use(express.json());
app.use(morgan("dev"));
app.use("/indexCafeterias",indexCafeteriaRouter)
